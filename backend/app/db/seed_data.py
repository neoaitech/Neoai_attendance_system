...
def seed_database(force_reseed: bool = False):
    ...
    try:
        ...
        n1 = Notification(
            ...
            entity_id=course_cv.id,
            action_view="classes",
            action_params=json.dumps({"class_id": course_cv.id}),
            details_json=json.dumps({
                "course_id": course_cv.id,
                "course_code": "CS-301",
        ...
        n2 = Notification(
            ...
            entity_type="ClassCourse",
            entity_id=course_ai.id,
            action_view="classes",
            action_params=json.dumps({"class_id": course_ai.id}),
            details_json=json.dumps({
